...
const sendCancellationEmailByDentist = async (
  patientEmail: string,
  ...
  const patientMailOptions = {
    ...
    html: `<p>Dear Patient,</p><p>Your appointment scheduled for:</p><p><strong>Date:</strong> ${formattedDate}</p><p><strong>Time:</strong> ${formattedTime}</p><p>have been cancelled.</p><p>Best regards,<br/>Pearl-Fix</p>`,
  };
  ...
  const dentistMailOptions = {
    ...
    html: `<p>Dear dentist,</p><p>Your appointment scheduled for:</p><p><strong>Date:</strong> ${formattedDate}</p><p><strong>Time:</strong> ${formattedTime}</p><p>have been successfully cancelled.</p><p>Best regards,<br/>Pearl-Fix</p>`,
  };
...
export default sendCancellationEmailByDentist;
